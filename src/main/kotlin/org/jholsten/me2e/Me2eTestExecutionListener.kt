...
/**
 * Test execution listener which starts the test environment before the execution of the tests start.
 * Furthermore, it collects relevant data after each test execution and generates the test report
 * after all tests were executed. This listener is automatically detected by JUnit.
 */
...
internal class Me2eTestExecutionListener : TestExecutionListener {
     ...
     * Initializes the report data aggregator and starts the test environment.
